...
void reactionGame() {
  ...
  lcd.print("READY"); // Inform the player to get ready
  ...
  lcd.clear();                 
  lcd.print("P");  // Ask the player to press the button as fast as possible

  unsigned long startTime = millis();  // Record the time rieght button press
